...
class Configuration {
    ...
    class RemoteControlConfiguration {
        ...
        public:
            void load(int &offset) {  
                SSID = Configuration::loadString(offset);
                Password = Configuration::loadString(offset);
            }

            void save(int &offset) {     
                Configuration::saveString(offset, SSID);
                Configuration::saveString(offset, Password);
            }
            ...
            size_t size() const {
                return sizeof(int) 
                    + Configuration::MaxStringLength * sizeof(char) 
                    + Configuration::MaxStringLength * sizeof(char);
            }
    };
    ...
    class ClockFaceConfiguration {
        ...
        public:
           void load(int &offset) {
                ...
                Configuration::loadCRGBColor(offset, ColorHour);
                Configuration::loadCRGBColor(offset, ColorMinute);
                Configuration::loadCRGBColor(offset, ColorSecond);
                Configuration::loadCRGBColor(offset, ColorHourMinute);
                Configuration::loadCRGBColor(offset, ColorHourSecond);
                Configuration::loadCRGBColor(offset, ColorMinuteSecond);
                Configuration::loadCRGBColor(offset, ColorAll);
            }
            ...
            void save(int &offset) {
                ...
                Configuration::saveCRGBColor(offset, ColorHour);
                Configuration::saveCRGBColor(offset, ColorMinute);
                Configuration::saveCRGBColor(offset, ColorSecond);
                Configuration::saveCRGBColor(offset, ColorHourMinute);
                Configuration::saveCRGBColor(offset, ColorHourSecond);
                Configuration::saveCRGBColor(offset, ColorMinuteSecond);
                Configuration::saveCRGBColor(offset, ColorAll);
            }
    ...
    class NtpTimeSourceConfiguration {
        ...
        public:
            ...
            void load(int &offset) {
                NTPServerName = Configuration::loadString(offset);
                SSID = Configuration::loadString(offset);
                Password = Configuration::loadString(offset);
            ...
            void save(int &offset) {
                Configuration::saveString(offset, NTPServerName);
                Configuration::saveString(offset, SSID);
                Configuration::saveString(offset, Password);
            ...
            size_t size() const {
                return Configuration::MaxStringLength * (char) 
                    + Configuration::MaxStringLength * (char) 
                    + Configuration::MaxStringLength * (char) 
    ...
    class SystemConfiguration {
        private:
            ...
            static const int ClockSourceTypeDefault = 0;
            
        public:
            static const int RtcClockSourceType = 0;
            static const int NtpClockSourceType = 1;
        ...
        public:
            void load(int &offset) {
                ...
                EEPROM.get(offset, ClockSourceType);
                offset += sizeof(int);
            }
            ...
            void save(int &offset) {
                ...
                EEPROM.put(offset, ClockSourceType);
                offset += sizeof(int);
            }

            void loadDefaults(int &offset) {
                TickTime = TickTimeDefault;
                ClockSourceType = ClockSourceTypeDefault;
    ...
    public:
        static const int MaxStringLength = 50;
    ...
    public:
        static char* loadString(int &offset) {
            uint8_t strLen = 0;
        ...
        static void saveString(int &offset, const char* str) {                
        ...
        static void loadCRGBColor(int &offset, CRGB& target) {
            int8_t r, g, b;
        ...
        static void saveCRGBColor(int &offset, const CRGB& target) {
...
const char* Configuration::RemoteControlConfiguration::SSIDDefault = "gigaClock";
const char* Configuration::RemoteControlConfiguration::PasswordDefault = "gigaClock";